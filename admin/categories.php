          ...
          <table class=" table mt-3">
            <thead class="table-dark">
              <tr>
                ...
                <th>Delete</th>
                <th>Top stories</th>
                <th class="<?php echo $_SESSION["username"]; ?> hidden">Publish</th>
              </tr>
            </thead>
            <tbody>
            <?php
              ...
              <tr>
                ...
                <td ><button   class="update " onclick="return   update(<?php echo $row['post_id'];?>);">UPDATE </button></td>
                <td ><a href="././singlepost.php?delete=<?php echo $row["post_id"] ?>"  >DELETE </a></td>
                <td ><a href="./singlepost.php?topstory=<?php echo $row["post_id"] ?>" ><?php echo $row["top_story"]?> </a></td>
                <td class="<?php echo $_SESSION["username"]; ?> hidden" ><a href="./singlepost.php?publish=<?php echo $row["post_id"] ?>"  ><?php echo $row["publish"]?> </a></td>
              </tr>
