<?php include('./separatedparts/header.php') ?>
        <section class="container">
          <div class="blog"><h2>POLITICS NEWS</h2></div>
          <?php $sql = "SELECT `post_id`,`title`,`image`,SUBSTRING(`content`,1,250) AS `content` ,`category`,`date` FROM `posts` WHERE `category` = 'politics' AND `publish`= 'true' ORDER BY `post_id` DESC ";
